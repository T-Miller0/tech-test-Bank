...
describe Statement do
  ...
  it 'Deposit shows date, amount and total balance' do
    ...
    expect(subject.account_statement).to eq [{ Date: '10/01/2012', Credit: 1000, Balance: 1000 }]
  end
  ...
  it 'shows a #withdrawal_statement' do
    ...
    expect(subject.account_statement).to eq [{ Date: '14/01/2012', Debit: -500, Balance: 500 }]
  end
